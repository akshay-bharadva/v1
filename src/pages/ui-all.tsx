    ...
    <Layout>
      <div className="container mx-auto px-4 py-12">
        <header className="mb-12 text-center">
          <h1 className="text-5xl font-bold tracking-tighter">UI Component Library</h1>
          <p className="mt-2 text-lg text-neutral-600">A showcase of all available components.</p>
        </header>
        <div className="space-y-16">
          ...
          <ComponentDisplay id="card" title="Card" description="A container for grouping related content.">
             <Card className="w-[350px]">
              ...
              <CardFooter className="border-t-2 flex justify-between"><Button variant="outline">Cancel</Button><Button>Deploy</Button></CardFooter>
            </Card>
          </ComponentDisplay>
          ...
          <ComponentDisplay id="navigation" title="Navigation" description="Components for navigating the application.">
              ...
              <Tabs defaultValue="account" className="w-[400px]"><TabsList><TabsTrigger value="account">Account</TabsTrigger><TabsTrigger value="password">Password</TabsTrigger></TabsList><TabsContent value="account"><p>Account content</p></TabsContent><TabsContent value="password"><p>Password content</p></TabsContent></Tabs>
           ...
           <ComponentDisplay id="loaders-feedback" title="Loaders & Feedback" description="Visual feedback for async operations.">
              ...
              <div className="flex items-center space-x-4"><Skeleton className="h-12 w-12" /><div className="space-y-2"><Skeleton className="h-4 w-[250px]" /><Skeleton className="h-4 w-[200px]" /></div></div>
          </ComponentDisplay>
