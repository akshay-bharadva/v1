...
const ComponentDocSection: React.FC<{
  ...
  <section
    id={id}
    className={cn(
      "mb-16 scroll-mt-24 rounded-none border-2 border-black bg-white px-6 py-8 shadow-[8px_8px_0px_#000]",
      className,
    )}
  >
    <header className="mb-6 border-b-4 border-black pb-4">
      <h2 className="text-3xl font-black text-black sm:text-4xl">{title}</h2>
      <p className="mt-1.5 text-md font-semibold text-gray-700">
        {description}
      </p>
    </header>
...
const VariationDisplay: React.FC<{
  ...
  <div
    id={id}
    className={cn(
      "mt-6 scroll-mt-24 rounded-none border-2 border-gray-400 bg-gray-50 p-4 shadow-[3px_3px_0px_#aaa]",
      className,
    )}
  >
