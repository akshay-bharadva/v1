/*
This component is redesigned for the "Digital Blueprint" theme.
- Cards use the `bg-blueprint-bg` style.
- Typography is updated to use monospace fonts for technical terms, enhancing the schematic feel.
*/
