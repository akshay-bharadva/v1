/*
This file is redesigned for the new kinetic typography theme.
- The heavy, neo-brutalist card is replaced with a clean, minimalist layout.
- The large, boxed exclamation mark is removed in favor of a bold typographic "404".
- Typography is updated to be modern and clean, using the theme's colors.
- The "Go Home" button is replaced with the redesigned `Button` component.
*/
