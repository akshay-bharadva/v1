                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {!dashboardData.stats ? (
                      ...
                      <>
                        ...
                        <StatCard
                          title="Monthly Net"
                          value={dashboardData.stats.monthlyNet.toLocaleString(
                            "en-US",
                            { style: "currency", currency: "USD" },
                          )}
                    ...
                    {!dashboardData.stats ? (
                      ...
                      <>
                        ...
                        <StatCard
                          ...
                          value={dashboardData.stats.totalBlogViews}
                          ...
                          >
                            <div>
                              <button
                                ...
                                className="text-left font-semibold text-foreground hover:text-accent hover:underline"
                              >
                                {post.title}
                              </button>
            ...
            {activeTab !== "dashboard" && (
              ...
              >
                ...
                {activeTab === "content" && (
                  <ContentManager
                    startInCreateMode={
                      initialAction === "createPortfolioSection"
                    }
                    onActionHandled={handleActionCompleted}
                  />
                )}
