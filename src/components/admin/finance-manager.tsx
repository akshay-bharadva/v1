                ...
                <TabsContent value="dashboard" className="mt-6 space-y-6">
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        <div className="lg:col-span-2 space-y-6">
                            <Card>
                                <CardHeader><CardTitle>Net Income Overview</CardTitle><CardDescription>Total earnings minus total expenses for the selected period: {date?.from ? format(date.from, "LLL dd, y") : '...'} - {date?.to ? format(date.to, "LLL dd, y") : '...'}</CardDescription></CardHeader>
