...
const MY_EXPERIENCES: ExperienceItem[] = [
  {
    ...
    desc: (
        <p>
            As an open-source contributor, I developed key pages like Pricing, Team, and Enterprise, and played a major role in the new landing page redesign. Check it out at <a href="https://signoz.io/" target="_blank" rel="noopener noreferrer" className="font-semibold text-accent hover:underline underline-offset-4">signoz.io</a>.
        </p>
    ),
  ...
  return (
    <section className="my-16 py-16">
      ...
      >
        ...
        <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-[6rem] font-black text-accent/5 -z-10 select-none" aria-hidden="true">
          CAREER
        </span>
      </motion.div>
