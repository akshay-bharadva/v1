...
- The modern styles are replaced with `border-2`, `rounded-none`, and ahard `shadow-[...]` on `DropdownMenuContent`.
- The dropdown panels now use `rounded-none`, a thick `border-2`, `bg-popover`, and a hard `shadow-[...]` for a raw, functional look.
- Item hover/focus states are updated to use the theme's high-contrast `accent` color.
- Font styles and separator colors are updated to align with the new stark theme variables.
*/
"use client";
