    ...
    return (
        ...
        >
            <div className="mb-10 flex size-full flex-col items-center justify-center gap-5">
                <div className="flex flex-col items-center gap-4 rounded-none border-2 border-foreground bg-card p-4 shadow-[4px_4px_0px_#000] dark:shadow-[4px_4px_0px_#FFF] sm:flex-row sm:gap-6">
                    <Image
                        src={"https://avatars.githubusercontent.com/u/52954931?v=4"}
                        alt="Akshay Bharadva avatar"
                        width={128}
                        height={128}
                        className="size-32 rounded-none border-2 border-foreground object-cover"
                        priority
                    />
