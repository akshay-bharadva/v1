/*
This file is updated to apply the "glassmorphism" style to the mobile header and its slide-out sheet.
- The top bar now uses `bg-glass`.
- `SheetContent` is styled with `bg-glass` for a consistent, premium feel.
*/
"use client";
...
export default function MobileHeader() {
  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-glass py-3 md:hidden">
